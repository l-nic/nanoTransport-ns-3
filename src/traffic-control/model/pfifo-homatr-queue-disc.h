...
#ifndef PFIFO_HOMATR_H
#define PFIFO_HOMATR_H
 ...
 */
class PfifoHomatrQueueDisc : public QueueDisc {
public:
  /**
  ...
  /**
   * \brief PfifoHomatrQueueDisc constructor
   *
   * Creates a queue with a depth of 1000 packets per band by default
   */
  PfifoHomatrQueueDisc ();

  virtual ~PfifoHomatrQueueDisc();
